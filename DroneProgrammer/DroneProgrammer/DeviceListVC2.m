...
#import "DroneProgrammer-Bridging-Header.h"

#import "DeviceListVC2.h"
#import "DroneDiscoverer.h"
#import <libARDiscovery/ARDISCOVERY_BonjourDiscovery.h>
#import "DroneProgrammer-Swift.h"
//#import "DroneProgrammer-Bridging-Header.h"
...
#define SELECT_SEGUE            @"selectSegue"
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if(([segue.identifier isEqualToString:BEBOP_SEGUE]) && (_selectedService != nil)) {
        ...
        [vc setService:_selectedService];
